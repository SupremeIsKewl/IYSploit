...
TextBox.Text = "This version of IYSploit has been discontinued."
...
Updates:Destroy() loadstring(game:HttpGet(('https://raw.githubusercontent.com/Ruben162/IYSploit/main/Loader_FD.lua'),true))() end UPDATE.MouseButton1Down:connect(Click) end 
else print('IYSploit is already running.') end
--script end
end
